...
requirejs(['phyzzy', 'vector'], function(phyzzy, vector) {
        main();
        });
...
function main() {
    ...
    ph.mesh.addS(0, 1, 1, 100, 0.4);
    ph.mesh.addS(1, 2, 1, 100, 0.4);
    ph.mesh.addS(2, 3, 1, 100, 0.4);
    ph.mesh.addS(0, 3, 1, 100, 0.4);
    ph.mesh.addS(2, 0, 1, 100, 0.4);
    ph.mesh.addS(1, 3, 1, 100, 0.4);
